    ...
    return (
        <div className='container mx-auto max-w-[1200px] p-3 overflow-hidden'>
            ...
            <Carousel responsive={responsive}>
                <div className='bg-transparent h-full justify-center items-center flex rounded-lg overflow-hidden relative p-5 group'>
                ...
                <div className='bg-transparent h-full justify-center items-center flex rounded-lg overflow-hidden relative p-5 group'>
                    ...
                    <div className='absolute p-5 backdrop-blur-xl bg-primary w-full h-full flex items-center opacity-0 scale-0 group-hover:scale-100 group-hover:opacity-100 transition ease-linier'>
                        <div className='text-center w-full text-white'>
                            ...
                            <p>
                                Develops enterprise software to manage business operation.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className='bg-transparent h-full justify-center items-center flex rounded-lg overflow-hidden relative p-5 group'>
                    ...
                    <div className='absolute p-5 backdrop-blur-xl bg-primary w-full h-full flex items-center opacity-0 scale-0 group-hover:scale-100 group-hover:opacity-100 transition ease-linier'>
                        <div className='text-center w-full text-white'>
                            ...
                            <p>
                                NoSQL, cross-platform, document-oriented database program.
                            </p>
                        </div>
                    </div>
                </div>
                <div className='bg-transparent h-full justify-center items-center flex rounded-lg overflow-hidden relative p-5 group'>
                    ...
                    <div className='absolute p-5 backdrop-blur-xl bg-primary w-full h-full flex items-center opacity-0 scale-0 group-hover:scale-100 group-hover:opacity-100 transition ease-linier'>
                        <div className='text-center w-full text-white'>
                            ...
                            <p>
                                Collaborative web application for interface design by desktop applications.
                            </p>
                        </div>
                    </div>
                </div>
